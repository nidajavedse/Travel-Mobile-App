...
public class UserProfileActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog g = new DatePickerDialog(UserProfileActivity.this, R.style.DialogTheme,new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void storeImage(){
        if(!username.getText().toString().isEmpty() && !fname.getText().toString().isEmpty()
            ...
            Toast.makeText(UserProfileActivity.this, "added successfully", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(UserProfileActivity.this,HomeActivity.class);
            startActivity(intent);
        }
        else {
            Toast.makeText(UserProfileActivity.this, "Please enter all the fields", Toast.LENGTH_SHORT).show();
        }
    }
}